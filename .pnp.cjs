  ...
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "packageRegistryData": [\
      ...
      ["@goldstack/template-dynamodb", [\
        ["npm:0.1.3", {\
          "packageLocation": "./.yarn/cache/@goldstack-template-dynamodb-npm-0.1.3-7578889ced-49ff225e5f.zip/node_modules/@goldstack/template-dynamodb/",\
          "packageDependencies": [\
            ["@goldstack/template-dynamodb", "npm:0.1.3"],\
            ["@aws-sdk/util-dynamodb", "npm:3.87.0"],\
            ["@goldstack/infra", "npm:0.3.35"],\
            ["@goldstack/infra-aws", "npm:0.3.43"],\
